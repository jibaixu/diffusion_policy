...
def debug_on():
    ...
    sys.argv = [
        ...
        "task.dataset.zarr_paths=['data/AllTasks-v3/zarr_panda_traj700_multiview', 'data/AllTasks-v3/zarr_widowxai_traj700_multiview', 'data/AllTasks-v3/zarr_xarm6_traj700_multiview', 'data/AllTasks-v3/zarr_xarm7_traj700_multiview']",
        "hydra.run.dir=outputs/train/AllTasks-v3/mixed",
        "training.seed=42",
